    ...
    <div className="bg-default max-w-xl overflow-hidden rounded-md shadow">
      <div className="px-4 py-5 sm:p-6">
        ...
        <div className="mt-4 space-y-4">
          <div className="bg-brand darked:bg-darkmodebrand overflow-hidden rounded-md">
            <div className="text-brandcontrast darked:text-darkmodebrandcontrast px-4 py-2 sm:px-6">
