  ...
  return (
    <div className="relative">
      <aside
        ...
        className="desktop-transparent bg-muted border-muted darked:bg-gradient-to-tr darked:from-[#2a2a2a] darked:to-[#1c1c1c] fixed left-0 hidden h-full max-h-screen w-14 flex-col overflow-y-auto overflow-x-hidden border-r md:sticky md:flex lg:w-56 lg:px-3">
