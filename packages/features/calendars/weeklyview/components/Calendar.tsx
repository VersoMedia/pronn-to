  ...
  return (
    <MobileNotSupported>
      <div
        ...
        <div
          ref={container}
          className="bg-default darked:bg-muted relative isolate flex h-full flex-auto flex-col">
          <div
            style={{ width: "165%" }}
            ...
            <div className="relative flex flex-auto">
              <CurrentTime />
              <div className="bg-default darked:bg-muted ring-muted border-default sticky left-0 z-10 w-14 flex-none border-l border-r ring-1" />
              <div
                className="darked:[--disabled-gradient-background:#262626] darked:[--disabled-gradient-foreground:#393939] grid flex-auto grid-cols-1 grid-rows-1 [--disabled-gradient-background:#F8F9FB] [--disabled-gradient-foreground:#E6E7EB]"
                style={{
