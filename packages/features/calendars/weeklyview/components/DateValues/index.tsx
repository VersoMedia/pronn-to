...
export function DateValues({ days, containerNavRef }: Props) {
  ...
  return (
    <div
      ref={containerNavRef}
      className="bg-default darked:bg-muted border-b-subtle rtl:border-r-default sticky top-[var(--calendar-dates-sticky-offset,0px)] z-[80] flex-none border-b border-r sm:pr-8">
