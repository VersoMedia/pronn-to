      ...
      <div
        ...
        <div
          ...
          className={classNames(
            ...
            "bg-default darked:bg-muted darked:[color-scheme:dark] grid max-w-full items-start sm:transition-[width] sm:duration-300 sm:motion-reduce:transition-none md:flex-row",
            ...
            <BookerSection
              ...
              className={classNames(
                ...
                (layout === BookerLayouts.COLUMN_VIEW || layout === BookerLayouts.WEEK_VIEW) &&
                  "bg-default darked:bg-muted sticky top-0 z-10"
              )}>
              <Header
