      ...
      <div className="max-h-[390px] overflow-scroll">
        {slots.map((slot) => (
          <div key={slot.time.format()} className="flex flex-row items-center ">
            <a
              className="min-w-48 border-brand-default text-bookingdarker  bg-default darked:border-transparent darked:bg-gray-600 mb-2 mr-3 block flex-grow rounded-md border py-2 text-center font-medium "
              data-testid="time">
