...
export const ANALYTICS_WRITE_KEY = process.env.NEXT_PUBLIC_ANALYTICS_WRITE_KEY || "";
...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://verso.is";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Verso";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "info@verso.ai";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Verso.is";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Verso";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Verso.is";
...
export const LOGO = "/verso-logo-large.svg";
export const LOGO_ICON = "/verso-isotipo.png";
...
export const ROADMAP = "https://verso.ai/roadmap";
export const DESKTOP_APP_LINK = "https://verso.ai/download";
export const JOIN_DISCORD = "https://verso.ai/discord";
export const POWERED_BY_URL = `${WEBSITE_URL}/?utm_source=embed&utm_medium=powered-by-button`;
export const DOCS_URL = "https://verso.ai/docs";
export const DEVELOPER_DOCS = "https://developer.verso.ai";
